...
- Mirsky & Lee (2021). The creation and detection of deepfakes: A survey. *ACM Computing Surveys*.
...
- Wang et al. (2022). M2TR: Multi-modal multi-scale transformers for deepfake detection. *ACM ICMR*.
- Tak et al. (2021). End-to-end anti-spoofing with RawNet2. *IEEE ICASSP*.
...
This project was developed for academic assessment purposes at the module CMP-L044. All code is original work by Group 7 members unless otherwise cited. The datasets used are subject to their respective Kaggle dataset licences.
